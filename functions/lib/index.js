...
exports.onMemberCompanyChange =
  exports.getMemberGroupList =
  exports.updateMemberGroups =
  exports.syncGroupMembership =
  exports.onMemberStatusChange =
  exports.onUserDocCreated =
  exports.onNewJobPosted =
  exports.onUserDelete =
  exports.matchJobsForUser =
  exports.verifyUnamEmail =
...
exports.matchJobsForUser = (0, firestore_1.onDocumentUpdated)(
  'users/{userId}',
  async (event) => {
    var _a, _b;
    ...
    if (
      !((_b = afterData.privacySettings) === null || _b === void 0
        ? void 0
        : _b.jobSearching)
    ) {
      return null;
...
exports.onNewJobPosted = (0, firestore_1.onDocumentCreated)(
  'jobs/{jobId}',
  async (event) => {
 ...
 */
exports.onUserDocCreated = (0, firestore_1.onDocumentCreated)(
  'users/{userId}',
  async (event) => {
    const snapshot = event.data;
    if (!snapshot) return;
    ...
    const added = await (0, google_admin_1.addMemberToGroup)(
      (0, group_config_1.getDefaultGroup)(),
      email
    );
    if (added) {
 ...
 */
exports.onMemberStatusChange = (0, firestore_1.onDocumentUpdated)(
  'users/{userId}',
  async (event) => {
    var _a, _b, _c, _d;
    const beforeData =
    ...
    const oldStatus =
      (_c = beforeData.lifecycle) === null || _c === void 0
        ? void 0
        : _c.status;
    const newStatus =
      (_d = afterData.lifecycle) === null || _d === void 0 ? void 0 : _d.status;
    ...
    switch (newStatus) {
      case 'active':
        ...
        await (0, google_admin_1.addMemberToGroup)(
          (0, group_config_1.getMembersGroup)(),
          email
        );
        await (0, google_admin_1.removeMemberFromGroup)(
          (0, group_config_1.getDefaultGroup)(),
          email
        );
        break;
      ...
      case 'deactivated':
        ...
        await (0, google_admin_1.removeMemberFromAllGroups)(
          email,
          (0, group_config_1.getAllGroups)()
        );
        break;
      case 'alumni':
...
exports.syncGroupMembership = (0, https_1.onCall)(async (request) => {
  ...
  try {
    ...
    console.error(
      'Error syncing group membership:',
...
exports.updateMemberGroups = (0, https_1.onCall)(async (request) => {
  ...
  for (const groupEmail of addToGroups || []) {
    const success = await (0, google_admin_1.addMemberToGroup)(
      groupEmail,
      memberEmail
    );
    if (success) {
  ...
  for (const groupEmail of removeFromGroups || []) {
    const success = await (0, google_admin_1.removeMemberFromGroup)(
      groupEmail,
      memberEmail
    );
    if (success) {
...
exports.getMemberGroupList = (0, https_1.onCall)(async (request) => {
  ...
  const groups = await (0, google_admin_1.getMemberGroups)(
    memberEmail,
    (0, group_config_1.getAllGroups)()
  );
...
Object.defineProperty(exports, 'onMemberCompanyChange', {
  enumerable: true,
  get: function () {
    return companies_1.onMemberCompanyChange;
  },
});
