...
const eventManager: DefaultGroup = {
  ...
  permissions: [
    ...
    ...viewAllOnResources(CONTENT_RESOURCES.filter((r) => r !== 'events')),
  ],
};
...
const newsletterEditor: DefaultGroup = {
  ...
  permissions: [
    ...
    ...viewAllOnResources(CONTENT_RESOURCES.filter((r) => r !== 'newsletter')),
  ],
};
...
const jcCoordinator: DefaultGroup = {
  ...
  description: 'Full control over journal club, view access to other content',
  isSystem: true,
  permissions: [
