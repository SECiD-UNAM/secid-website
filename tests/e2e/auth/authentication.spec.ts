...
test.describe('Authentication Flow', () => {
  ...
  test.describe('Sign Up', () => {
    test('should display signup form correctly', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="university-select"]')
      ).toBeVisible();
    ...
    test('should validate password strength', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="password-error"]')
      ).toContainText(/password must be at least/i);
    });
    ...
    test('should successfully create account with valid data', async ({
      ...
      await expect(
        page.locator('[data-testid="verification-message"]')
      ).toContainText(/check your email/i);
    });
  ...
  test.describe('Social Authentication', () => {
    test('should display social login options', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="linkedin-login-button"]')
      ).toBeVisible();
    });
  ...
  test.describe('Two-Factor Authentication', () => {
    test('should prompt for 2FA when enabled', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="2fa-verification-form"]')
      ).toBeVisible();
      await expect(
    ...
    test('should validate 2FA code', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="2fa-error"]')).toContainText(
        /invalid code/i
      );
    });
  ...
  test.describe('Session Management', () => {
    ...
    test('should handle concurrent sessions', async ({ page, context }) => {
      ...
      await page.reload();
      await expect(
        page.locator('[data-testid="session-changed-message"]')
      ).toBeVisible();
    });
  });
});
