...
class MobileExperienceFlow {
  ...
  async testMobileNavigation() {
    ...
    for (const item of menuItems) {
      await expect(
        this.page.locator(`[data-testid="mobile-menu"] a[href="${item.href}"]`)
      ).toBeVisible();
    }
  ...
  async testTouchInteractions() {
    ...
    const tapTargets = this.page.locator(
  ...
  async testSwipeGestures() {
    ...
    const carousel = this.page.locator(
      '[data-testid="carousel"], [data-testid="slider"]'
    );
  ...
  async testMobileSearch() {
    ...
    await expect(
      this.page.locator('[data-testid="mobile-search-suggestions"]')
    ).toBeVisible();
  ...
  async testPullToRefresh() {
    ...
    await expect(
      this.page.locator('[data-testid="refresh-indicator"]')
    ).toBeVisible();
  ...
  async testMobileOrientation() {
    ...
    await expect(
      this.page.locator('[data-testid="mobile-portrait-layout"]')
    ).toBeVisible();
    ...
    await expect(
      this.page.locator('[data-testid="mobile-landscape-layout"]')
    ).toBeVisible();

    // Navigation should adapt to landscape
    await expect(
      this.page.locator('[data-testid="landscape-navigation"]')
    ).toBeVisible();
  }
...
test.describe('Mobile Experience Tests', () => {
            ...
            jobs: [
              {
                ...
                description:
                  'Mobile-optimized job posting for data science role.',
              },
            ],
          }),
        });
  ...
  test('mobile search experience', async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="mobile-filters-drawer"]')
    ).toBeVisible();
  ...
  test('mobile gesture interactions', async ({ page }) => {
    ...
    const zoomableElement = page.locator(
      '[data-testid="zoomable-image"], [data-testid="chart"]'
    );
  ...
  test('mobile orientation changes', async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="landscape-dashboard"]')
    ).toBeVisible();
