...
describe('SearchBar', () => {
  ...
  describe('Voice Search', () => {
    ...
    it('hides voice search button when disabled', () => {
      ...
      const voiceButton = screen.queryByRole('button', {
        name: /voice search/i,
      });
  ...
  describe('Error Handling', () => {
    it('handles suggestion fetch errors gracefully', async () => {
      ...
      expect(
        screen.queryByRole('button', { name: /suggestion/i })
    ...
    it('has proper suggestion button accessibility', async () => {
      ...
      await waitFor(() => {
        ...
        const suggestionButton = suggestions.find((btn) =>
          btn.textContent?.includes('data scientist')
        );
