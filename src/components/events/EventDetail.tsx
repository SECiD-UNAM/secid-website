    ...
    <div>
      ...
      <div className="mb-6 overflow-hidden rounded-lg bg-white shadow-lg dark:bg-gray-800">
        ...
        {event.imageUrl ? (
          ...
          <div className="flex h-64 w-full items-center justify-center bg-gradient-to-br from-primary-400 to-primary-600">
        ...
        <div className="p-8">
          ...
          <div className="mb-4 flex flex-wrap gap-2">
            {event.featured && (
              <span className="inline-flex items-center rounded-full bg-yellow-100 px-3 py-1 text-xs font-semibold text-yellow-700 dark:bg-yellow-900/20 dark:text-yellow-400">
            ...
            {event['status'] === 'cancelled' && (
              <span className="inline-flex items-center rounded-full bg-red-100 px-3 py-1 text-xs font-semibold text-red-700 dark:bg-red-900/20 dark:text-red-400">
          ...
          <div className="mb-6 flex items-start justify-between">
            <div>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400">
                {lang === 'es' ? 'Organizado por' : 'Organized by'}{' '}
            ...
            {event.location['type'] === 'virtual' ? (
              ...
              <div>
                <div className="mb-4 flex items-start">
                  <MapPinIcon className="mr-2 mt-0.5 h-5 w-5 text-gray-500" />
                  <div>
                    <p className="font-medium text-gray-900 dark:text-white">
                      {event.location.venue}
                    </p>
