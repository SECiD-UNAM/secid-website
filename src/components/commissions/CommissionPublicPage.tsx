...
export default function CommissionPublicPage({
  commissionId,
  lang = 'es',
}: Props) {
  ...
  return (
    <div style={{ maxWidth: '900px', margin: '0 auto' }}>
      ...
      >
        ...
        >
          <i
            className={iconMap[commission.icon] || 'fas fa-cog'}
            style={{ fontSize: '2rem' }}
          />
        ...
        <p style={{ fontSize: '0.875rem', opacity: 0.8, marginTop: '1rem' }}>
          {t.established}:{' '}
          {commission.establishedAt.toLocaleDateString(
            lang === 'es' ? 'es-MX' : 'en-US',
      ...
      >
        ...
        >
          <i
            ...
            style={{ color: commission.color, marginRight: '0.5rem' }}
          />
          {t.features}
        </h2>
        <ul
          ...
          {commission.features.map((feature, i) => (
            ...
            >
              <i
                ...
                style={{ color: commission.color, flexShrink: 0 }}
              />
              {feature}
            </li>
          ))}
